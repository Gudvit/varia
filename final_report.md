...
> **Ситуация на 23.09.2026 — критическая.** Офтальмолог Retina зафиксировал ухудшение роговиц с **кератомаляцией обоих глаз** и рекомендовал срочную операцию (кросслинкинг + ACell Vet + тарзорафия, шанс успеха ~60%; без неё возможна энуклеация). Врач LoVet в тот же вечер записала: «состояние Вари нехорошее» (англ. «not good»): аппетит резко снижен (⚠️ формулировку «1 чайная ложка в день» владелец уточнил как заострённую, см. ниже), сама не пьёт — воду владельцы дают из шприца, лечение воспаления желудка не даёт эффекта; выпот в грудной клетке сохраняется. Проведение операции, по её оценке, возможно только через круглосуточный стационар (в/в обезболивание и противорвотные, дренирование грудной клетки, вероятно назальный зонд); риск высокий (разд. 4, записи 23.09.2026).
...
- **Резко сниженный аппетит, воспаление желудка по УЗИ, тошнота:** по анамнезу 23.09 — «неделю около 1 чайной ложки корма в день», сама не пьёт (воду владельцы дают из шприца; владелец связывает отказ с болью в глазах). ⚠️ «1 чайная ложка в день» — формулировка владельца, по его уточнению намеренно заострённая, чтобы клиника отреагировала; реальный объём съеденного не измерялся (разд. 4, наблюдение владельца 23.09). После нанесения Mirataz вечером 23.09, со слов владельца, поела и помочилась. 21.09 на AFAST — признаки воспаления желудка («cechy zapalenia żołądka»); тошнота не купируется ни Cerenia, ни ондансетроном, ни но-шпой. Вес −4% за 9 дней. Врач 23.09: «не отвечает на лечение воспаления желудка». Тест на панкреатит (fPL) запланирован 21.09, результата нет (разд. 12).
- **Плевральный выпот сохраняется:** 21.09 — 1.15 см слева / 0.89 см справа, 23.09 — 1.6 см слева / ~2.6 см справа, дыхание учащённое. ⚠️ Цифры получены разными врачами и, со слов владельца, разной методикой; устно врачи оценивают уровень как примерно постоянный; дома всю неделю 34–40/мин (со слов владельца; неделей раньше — в основном 30–36). Последняя фактическая пункция — 06.07.2026. Врач связывает возможное накопление со снижением стероида 21.09 (разд. 4).
...
2. **Питание и гидратация:** сама не пьёт, воду владельцы дают из шприца — объём в мл/сутки стоит записывать и сообщить врачу. Аппетит резко снижен около недели; точный объём потребления неизвестен (формулировка «1 чайная ложка» заострена владельцем). Вечером 23.09 после Mirataz кошка поела — стоит зафиксировать, сохраняется ли эффект. Врач упоминает назальный зонд в условиях стационара.
3. **Шестая доза доксорубицина** (~28.09.2026): 21.09 запланирована, после 23.09 её уместность не обсуждалась.
4. **Плевральный выпот:** нужна ли пункция сейчас — 23.09 это названо частью стационарного плана, отдельно не решено.
5. **Доза стероида** — три решения за две недели (5 мг → 3/4 табл. 07.09 → 5 мг 11.09 → 3/4 табл. 21.09) с противоположными последствиями для выпота, желудка и роговицы; риск/польза между клиниками не согласованы.
6. **Подкожное образование 0.46 см** и **разрастания стенки грудной клетки** — вероятные признаки прогрессии, не верифицированы.
7. **Mirataz (миртазапин)** назначен при том, что ранее миртазапин вызывал запор (анамнез 14.09.2026).
...
- ЖКТ: эпизод тяжёлого запора 10.07.2026, потенциально ведущего к мегаколон; исход не задокументирован. С 11.09.2026 — стойко сниженный аппетит, тошнота и дискомфорт; **14.09.2026 на УЗИ — поджелудочная железа пониженной эхогенности и незначительные признаки воспаления желудка**; **21.09.2026 — УЗИ-признаки воспаления желудка**; к 23.09.2026 — неделю почти не ест и не пьёт, тошнота не купируется, вес 4.6 кг.
...
- **Решение по операции на глазах** — позиции офтальмолога (срочная операция) и лечащего врача (только через круглосуточный стационар, высокий риск) от 23.09.2026 нужно свести вместе.
...
⚠️ **Продолжение, 17–24.09.2026 (со слов владельца, без поимённого журнала):** всю неделю 34–40/мин. По сравнению с 10–16.09 (диапазон 26–38, большинство значений 30–36) нижняя граница поднялась примерно с 28–30 до 34, а верхняя — до 40. Это согласуется с записью LoVet 23.09 «дыхание учащённое»; сантиметровые цифры УЗИ разных врачей для сравнения непригодны (устно — «примерно на том же уровне»). Ограничение то же: не указано, какие значения получены во сне.

**Что показывают эти данные (10–16.09):**
...
**AFAST:** поджелудочная железа — левая доля гомогенная, не увеличена, без очаговых изменений; правая доля незначительно пониженной эхогенности. **Признаки воспаления желудка** («cechy zapalenia żołądka»): чётко выраженный мышечный слой стенки желудка, газ, гиперэхогенный окружающий жир. **Новая находка: подкожное образование в области живота диаметром 0.46 см — в дифференциальной диагностике следует учитывать рецидив** («w diagnostyce różnicowej do uwzględnienia wznowa»).

Лечение воспаления желудка («leczenie zapalenia żołądka»): но-шпа (дротаверин) 1–2×/день п/к; Cerenia 1×/день п/к; Ranigast (фамотидин) 20 мг 1/4 табл. 2×/день. **Через неделю — химиотерапия** (то есть ~28.09.2026); при тревожных симптомах — контакт с клиникой. **Преднизолон снова снижен до 3/4 табл./день** («REDUCTION OF PREDNICORTONE: 3/4 PILL PER DAY»).
...
⚠️ Плевральный выпот: 21.09 — 1.15 см слева / 0.89 см справа «на высоте сердца», 23.09 — 1.6 см слева / ~2.6 см справа «со стороны сердца», дыхание учащённое. Измерения выполнены разными врачами. ⚠️ Со слов владельца, врачи измеряют по-разному, отсюда и разброс цифр, а устно говорят, что уровень жидкости держится примерно на одном уровне. Поэтому разницу 21.09 → 23.09 нельзя читать как рост. Врач связывает возможное накопление жидкости со снижением стероида (21.09 доза снижена до 3/4 табл.).
...
- **Вода:** сама кошка не пьёт — воду ей дают из шприца. Владелец предполагает, что отказ пить самостоятельно связан с болью в глазах. Объём выпиваемого из шприца не записывался. ⚠️ Другие возможные причины, которые по наблюдению дома не отделить: тошнота и воспаление желудка (кошки с тошнотой часто отказываются и от воды), общая слабость, а также то, что при поении из шприца жажда может просто не возникать. Для оценки гидратации врачу важнее всего знать, сколько миллилитров в сутки кошка получает.
- **После нанесения Mirataz на ухо** (в клинике LoVet в 21:15) кошка **поела и помочилась**, после чего лежит.
- **Частота дыхания — 35–36/мин** (состояние — сон или бодрствование — не уточнено). **По словам владельца, всю неделю (примерно 17–24.09) дыхание держится на 34–40/мин.** Отдельных записей с временем и пометкой «сон» за этот период нет.
...
#### 24.09.2026 — наблюдение владельца (медицинского документа нет)

- **Частота дыхания 32/мин** — в покое, кошка засыпает (не глубокий сон). Это самое низкое значение из названных владельцем за неделю (34–40). Замер в глубоком сне не проводился.
- **Дан сукральфат** — по назначению LoVet от 23.09.2026 (1 мл 2×/день за 30 минут до еды). Точное время не записано.

⚠️ Сукральфат обволакивает слизистую желудка и может снижать всасывание других пероральных препаратов; обычно их рекомендуют разносить примерно на 2 часа. По назначениям 23.09 Helicid (омепразол) даётся с едой, то есть через ~30 минут после сукральфата, а преднизолон также даётся перорально. Порядок и интервалы между ними в документах не заданы — см. разд. 15.
...
| Famogast/Ranigast (фамотидин) | 19.08.2026; 21.09.2026 | 19.08 — 20 мг, схема не описана. 21.09 — 1/4 табл. 2×/день в рамках лечения воспаления желудка. ⚠️ В назначениях 23.09.2026 не упомянут |
| Helicid 20 мг (**омепразол**) | с 23.09.2026 | 1/4 капсулы 2×/день с едой. ⚠️ Заменяет ли фамотидин или добавлен к нему — не указано |
| No-spa (**дротаверин**) инъекции | 21.09.2026 | 1–2×/день п/к при воспалении желудка; дома введена 21.09 в 10:00. 23.09 — со слов владельца, не помогает |
...
**21.09.2026** — на AFAST **признаки воспаления желудка** («cechy zapalenia żołądka»): чётко выраженный мышечный слой стенки желудка, газ, гиперэхогенный окружающий жир. Поджелудочная железа: левая доля гомогенная, не увеличена, без очаговых изменений; правая — незначительно пониженной эхогенности. **fPL запланирован на следующий визит.** Начато лечение воспаления желудка: но-шпа п/к, Cerenia п/к, Ranigast.
...
- **Общее состояние:** по записи лечащего врача LoVet 23.09.2026 — «нехорошее» (англ. «not good»), «виден огромный дискомфорт». Аппетит резко снижен около недели (⚠️ «1 чайная ложка в день» — заострённая формулировка владельца); вечером 23.09 после Mirataz поела и помочилась, ЧДД 35–36/мин (со слов владельца). Температура 38.5 °C, слизистые розовые, влажные.
...
- **Плевральный выпот:** сохраняется — 21.09: 1.15 см слева / 0.89 см справа, 23.09: 1.6 см слева / ~2.6 см справа; дыхание учащённое. ⚠️ Устно врачи оценивают уровень как примерно тот же; цифры разных врачей несопоставимы. **Дома всю неделю 34–40/мин** (со слов владельца), тогда как 10–16.09 — в основном 30–36. Последняя фактическая пункция — 06.07.2026; 23.09 дренирование упомянуто как часть стационарного плана.
- **ЖКТ:** признаки воспаления желудка по УЗИ (21.09); по записи врача 23.09 — лечение не даёт эффекта; тошнота не купируется. Поджелудочная 23.09 — без отклонений; fPL не выполнен.
...
- **Динамика плеврального выпота:** письменные УЗИ-измерения 02.09 и 07.09 различаются, устные оценки 07.09, 11.09 и 14.09 сводились к «без изменений»/«умеренное количество». 21.09 впервые указана точка измерения («на высоте сердца»): 1.15 см слева / 0.89 см справа; 23.09 — 1.6 / ~2.6 см «со стороны сердца» при учащённом дыхании. ⚠️ По словам владельца, врачи измеряют по-разному, а устно оценивают уровень как примерно постоянный — поэтому рост по этим цифрам утверждать нельзя. Критерии пункции по-прежнему не заданы; последняя фактическая пункция — 06.07.2026.
...
- **Поджелудочная железа и желудок:** 14.09 — поджелудочная пониженной эхогенности, незначительные признаки воспаления желудка; 21.09 — правая доля незначительно гипоэхогенна, признаки воспаления желудка (мышечный слой, газ, гиперэхогенный жир); 23.09 — область поджелудочной без отклонений. fPL запланирован 21.09 «на следующий визит», 23.09 результата нет. По записи врача 23.09 лечение воспаления желудка эффекта не даёт. ⚠️ «Воспаление желудка» — вывод по УЗИ-признакам; эндоскопии или биопсии не было.
...
- **Сукральфат и другие пероральные препараты:** по схеме 23.09 сукральфат даётся за 30 минут до еды, а Helicid (омепразол) — с едой; преднизолон также перорально. Сукральфат может снижать всасывание других препаратов, обычно их разносят примерно на 2 часа. Порядок приёма в документах не определён — уточнить у лечащего врача.
