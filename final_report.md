...
*Период документов: 24.06.2025 – 14.09.2026*

*Отчёт составлен: 08.09.2026; обновлён 16.09.2026*

*Владелец: Karina Grakova*

![Варя — чёрная британская длинношёрстная кошка](assets/varia-portrait.jpg)

## Клиническое резюме / текущий статус на 14.09.2026
...
| | |
| --- | --- |
| **Пациент** | Кошка, британская длинношёрстная, кастрирована, чёрная. Дата рождения 25.08.2014, возраст 12 лет на 14.09.2026; ⚠️ в документах разных клиник встречаются возрастные расхождения (разд. 2). Вес 4.78 кг на 14.09.2026 (⚠️ в поле «Waga» того же документа — 4.87 кг); снижение с 5.2 кг в июле. |
...
| **Химиотерапия** | Карбоплатин 200 мг/м² — одна доза 18.05.2026; введение 08.06.2026 отменено из-за тяжёлой нейтропении (Neu# 0.45). С 15.06.2026 — доксорубицин 1 мг/кг каждые 21 день; введено 5 доз, последняя 07.09.2026. На визите 14.09.2026 очередная доза не вводилась — проводился онкологический контроль (разд. 7). |
...
| **Терапия на 14.09.2026** | **Преднизолон:** доза снижалась до 3/4 табл./день с 07.09.2026, но **возвращена к 1 целой таблетке (5 мг) 11.09.2026** и оставлена без изменений 14.09. **Фуросемид:** был отменён с 27.07.2026, однако ⚠️ **13–14.09.2026 применён снова** (10 мг, 1/4 табл., по потребности) — прежнее утверждение о полной отмене больше не актуально. Varenzin отменён 07.09.2026. Добавлены: бупренорфин (Bupredine/Bunondol) каждые 12 часов — с 14.09 обозначен как обезболивание «для глаз»; Peritol 1/4 табл. 2×/день как стимулятор аппетита; Cerenia 60 мг 1/8 табл./день постоянно; Gastrovom 1 саше/день. Офтальмологическая схема расширена: добавлен противовирусный Acatavir и установлены бандажные контактные линзы (разд. 9, 10). |

#### Активные проблемы на последнюю задокументированную дату

- **Плевральный выпот:** присутствует хронически/рецидивирует с апреля 2026 года. Последние оценки: 11.09.2026 — «такое же количество, как при последнем исследовании»; 14.09.2026 — «умеренное количество свободной жидкости с обеих сторон». **От пункции 14.09.2026 отказались из-за стабильного состояния пациентки**; последняя фактически выполненная пункция — в июле 2026. ⚠️ Сантиметровые значения 02.09 (0.8/0.53 см) и 07.09 (2.0/1.5 см) по-прежнему расходятся с устной оценкой онколога «без изменений»; в записи от 11.09.2026 это расхождение зафиксировано письменно: «сначала 1 см, потом 0.8 см, теперь 2 см, но от dr Drewniak информация, что без изменений». Требуется стандартизированная повторная оценка.
- **Роговица:** двусторонний дефект эпителия на фоне синдрома сухого глаза, плохо поддающийся лечению. На 4-м визите 10.09.2026 офтальмолог констатировал **ухудшение несмотря на интенсивное лечение**, установил **бандажные контактные линзы** на оба глаза и впервые назначил противовирусный Acatavir. ⚠️ Числовая оценка площади дефекта на 10.09 (~70% на обоих глазах) не согласуется со словесным выводом об ухудшении и с прежними цифрами OD ~70% / OS ~80% — как точные измерения эти оценки сравнивать нельзя (разд. 10).
- **Анемия:** ⚠️ статус изменился. На бланке IDEXX от 14.09.2026 RBC (10.27 ×10¹²/л), гематокрит (0.38 л/л) и гемоглобин (114 г/л) — **в пределах референса лаборатории**, то есть анемии на эту дату бланк не показывает, хотя к 07.09.2026 отмечалось снижение этих же показателей. Сохраняются сниженный MCH (11.1 пг) и высокий RDW (31.4%). Оценивать динамику следует с учётом отмены Varenzin (молидустат, 19.08–07.09.2026) и препаратов железа (Suiferrin с 03.08.2026). Лёгкий микроцитоз документирован ещё **до** первой операции (06.08.2025) (разд. 8).
...
- **Почки:** эпизоды азотемии с 20.12.2025, рентгенопозитивные структуры в почках и мочевом пузыре (10.07.2026, ⚠️ повторно не проверены). Биохимия на 14.09.2026 в норме (креатинин 126 мкмоль/л, мочевина 6.85 ммоль/л), однако на AFAST 14.09.2026 описаны **изменённые почки с обеих сторон** (неровный контур), тогда как 24.06.2026 описывалась только левая почка (разд. 8.1, 13).
- **Аппетит и тошнота:** аппетит стойко снижен с 11.09.2026, отмечаются тошнота и дискомфорт; назначены стимулятор аппетита (Peritol) и постоянное противорвотное (Cerenia 60 мг 1/8 табл./день).
- **Новые находки 14.09.2026:** на TFAST — **разрастания в пределах стенки грудной клетки**; на AFAST — поджелудочная железа пониженной эхогенности и незначительные признаки воспаления желудка (разд. 12).
...
1. **Дальнейшая противоопухолевая стратегия после 5 доз доксорубицина:** требуется объективная оценка ответа на лечение и решение, нужна ли дальнейшая системная терапия; отдельно обсудить возможную роль повторного назначения Palladia, которая фактически была прекращена после эпизода тяжёлой нейтропении 08.06.2026.
...
3. **Тактика в связи с контактом опухолевых клеток с гистологическими краями материала** после операции 20.03.2026 в документах отдельно не описана.
4. **Уточнить реальную динамику плеврального выпота:** письменные УЗИ-измерения 02.09 и 07.09 различаются, но устные оценки 07.09, 11.09 и 14.09 сводятся к «без изменений»/«умеренное количество». Желательно при следующем контроле использовать сопоставимую методику оценки и чётко фиксировать динамику, в том числе решение о том, при каких критериях выполнять пункцию (14.09 от неё отказались).
5. **Разрастания в пределах стенки грудной клетки**, впервые описанные на TFAST 14.09.2026, — требуется уточнить, идёт ли речь о новой находке или о ранее известных изменениях, и нужна ли верификация.
6. **Образование у верхушки сердца/в средостении:** определить, требует ли оно дополнительной визуализации/верификации и повлияет ли это на дальнейшую тактику.
7. **Рентгенопозитивные структуры в почках/пузыре** от 10.07.2026 — не перепроверены.
8. **Роговица не отвечает на интенсивную терапию** более месяца: требуется решение о дальнейшей офтальмологической тактике и о допустимости текущей дозы кортикостероида, возвращённой к 5 мг/день 11.09.2026.

Полный перечень из 51 открытого вопроса и расхождения между документами — раздел 15.
...
| 14.09.2026 | 4.78 / 4.87 | ⚠️ в описании осмотра 4.78, в поле «Waga» того же документа — 4.87; последнее известное значение |

Общая динамика: вес был относительно стабилен (4.8–5.3 кг) на протяжении химиотерапии, с постепенным небольшим снижением к сентябрю 2026 года. В диапазоне 07–14.09.2026 вес колеблется в пределах 4.77–4.87 кг, то есть фактически стоит на месте; ⚠️ в двух документах подряд (11.09 и 14.09) вес внутри одного и того же бланка указан дважды и по-разному, поэтому точность этих значений ограничена.
...
**Текущая терапия (на 14.09.2026):** химиотерапия доксорубицином — введено V доз, последняя 07.09.2026, интервалы строго по 21 дню; на визитах 11.09 и 14.09 препарат не вводился, решение о шестой дозе (ожидаемой ~28.09.2026) в документах не зафиксировано. Ранее — **одна документированная доза карбоплатина** (18.05.2026), на фоне которой продолжалась Palladia; запланированное следующее введение карбоплатина 08.06.2026 отменено/отложено из-за тяжёлой нейтропении, после чего, по словам владельца, были прекращены и карбоплатин, и Palladia; с 15.06.2026 начат доксорубицин. На 14.09.2026: преднизолон 1 целая табл. (5 мг) — доза снижалась до 3/4 табл. 07.09, но возвращена к 5 мг 11.09; Varenzin отменён 07.09; ⚠️ фуросемид, считавшийся отменённым с 27.07.2026, **возобновлён 13–14.09.2026** (10 мг, 1/4 табл., по потребности); постоянное обезболивание бупренорфином каждые 12 часов «для глаз»; Peritol как стимулятор аппетита и Cerenia 60 мг 1/8 табл./день как постоянное противорвотное; поддерживающая терапия ЖКТ, почек и глаз.
...
- Глаза: с середины августа 2026 — тяжёлый, плохо поддающийся лечению двусторонний дефект эпителия роговицы (синдром сухого глаза), возможно связанный с системной терапией и/или носительством FHV1. **10.09.2026 — ухудшение несмотря на интенсивное лечение**: установлены бандажные контактные линзы на оба глаза, добавлен противовирусный Acatavir; с 14.09 — постоянная опиоидная анальгезия «для глаз».
- ЖКТ: эпизод тяжёлого запора 10.07.2026, потенциально ведущего к мегаколон; исход не задокументирован. С 11.09.2026 — стойко сниженный аппетит, тошнота и дискомфорт; **14.09.2026 на УЗИ — поджелудочная железа пониженной эхогенности и незначительные признаки воспаления желудка**.
...
**Наиболее срочные открытые вопросы для нового врача** (полный список из 51 пункта — раздел 15):
...
- ⚠️ Динамика плеврального выпота неоднозначна: письменные УЗИ-измерения 02.09 и 07.09.2026 различаются, но устные оценки 07.09, 11.09 и 14.09 сводятся к «без изменений»/«умеренное количество». 14.09 от пункции отказались ввиду стабильного состояния; последняя фактическая пункция — в июле 2026.
- Решение о шестой дозе доксорубицина (ожидаемой ~28.09.2026) не зафиксировано, при том что гематологического препятствия на 14.09.2026 не видно.
...
Назначения — строго в указанном порядке и с выдержкой интервалов: Acatavir 4×/день → 2 мин перерыв → Tobrex 4×/день → 2 мин → Vital Drop 3×/день → 5 мин → Corneregel 2×/день → 2 мин → Optixcare минимум 4–6×/день → 10 мин перерыв перед сывороткой → аллогенная сыворотка 4×/день (препарат хранить в холодильнике). Контроль в течение 14 дней или без промедления при тревожных симптомах. Возраст в документе: 12 лет 8 месяцев.

⚠️ Числовое расхождение: 25.08 и 03.09.2026 дефект оценивался как OD ~70% / OS ~80%, а 10.09.2026 — ~70% с обеих сторон, при том что в выводах того же документа указано ухудшение. Эти оценки нельзя сопоставлять как точные измерения площади.
...
#### 14.09.2026, 15:30 — LoVet, lek. wet. Aldona Gromny: онкологический контроль (последний известный визит)
...
⚠️ Фруктозамин указан в перечне выполненных услуг, но бланк с результатом не получен.
...
**Это последняя дата, документированная в загруженных материалах на момент обновления отчёта (16.09.2026).**

#### 13.09–16.09.2026 — наблюдение владельца (медицинского документа нет)

С **13.09.2026** капли даются строго по схеме от 10.09.2026, с соблюдением предписанных интервалов между препаратами; ранее интервалы не выдерживались. К **16.09.2026**, то есть после трёх дней применения по правильной схеме, владелец отмечает улучшение со стороны глаз.

Это **не объективные клинические данные** — офтальмологического осмотра после 10.09.2026 на момент обновления отчёта не было; ближайший контроль по назначению — до 24.09.2026.
...
На визитах 11.09.2026 (внеплановый, по поводу плохого самочувствия) и 14.09.2026 (онкологический контроль) химиопрепарат не вводился. При сохранении 21-дневного интервала следующая доза приходилась бы примерно на **28.09.2026**; решение о её введении в имеющихся документах не зафиксировано — см. раздел 15.
...
- **Глюкоза выше референса в четырёх измерениях подряд** (6.85 → 16.47 → 6.93 → 8.55 ммоль/л). Отдельные значения объяснимы стрессовой гипергликемией, но повторяемость находки в документах не обсуждается; фруктозамин 14.09.2026 был назначен — по-видимому, именно для разграничения стрессовой гипергликемии и диабета, — однако его результат не получен.
...
| Prednicortone / преднизолон | с ~27.04.2026 | 5 мг/день → 7.5 мг (1.5 табл.) с 15.06 → 5 мг с 17.08 → 3/4 табл. с 07.09.2026 → **снова 1 целая табл. (5 мг) с 11.09.2026**, без изменений 14.09.2026. Снижение дозы в августе–сентябре проводилось в т.ч. по рекомендации офтальмолога; возврат к 5 мг 11.09 с офтальмологической проблемой в документах не соотнесён |
...
| Bupredine / Bunondol (**бупренорфин**) | с 11.09.2026, постоянно | Опиоидный анальгетик. 11.09: 1 шприц на десну или слизистую щеки 2×/день. 14.09: каждые 12 часов, в карте прямо указано назначение «для глаз!» — то есть обезболивание офтальмологической боли. ⚠️ По анамнезу 14.09 владелец опиоиды в предшествующие дни не давал |
...
| Cerenia 60 мг табл. (**маропитант**) | с 14.09.2026, постоянно | 1/8 табл./день как постоянное противорвотное — в отличие от прежнего применения маропитанта только в дни химиотерапии |
| Зофран (**ондансетрон**) | 11.09.2026 | Дан владельцем однократно при признаках тошноты (кошка облизывалась); назначение и схема в документах не описаны |
...
| Бандажные контактные линзы | установлены 10.09.2026 | Лечебные линзы на оба глаза («SZKŁO KONTAKTOWE 2») при обширных дефектах эпителия роговицы |
...
**Итог на 14.09.2026:** хронический, плохо поддающийся лечению двусторонний дефект эпителия роговицы (синдром сухого глаза), возможно связанный с системной терапией (кортикостероиды, химиотерапия) и/или носительством FHV1. Последняя оценка площади дефекта — ~70% с обеих сторон (10.09.2026) при словесном выводе офтальмолога об ухудшении. Лечение эскалировано: бандажные контактные линзы, противовирусный препарат, постоянная опиоидная анальгезия.

⚠️ Количественные оценки площади дефекта по визитам — 70%/80% (25.08), 70%/80% (03.09), 70%/70% (10.09) — не следует читать как измерения: на 10.09 цифра по левому глазу формально ниже, а вывод документа — «ухудшение, бóльшие площади дефекта эпителия». Для суждения о динамике нужна сопоставимая методика оценки или фотодокументация.

⚠️ **Вопрос о Yellox (бромфенак).** Препарат назначен LoVet 17.08.2026, при обнаружении язв роговицы. В схемах офтальмолога Retina он не фигурирует ни 25.08, ни 10.09.2026 — там перечислены Acatavir, Tobrex, Vital Drop, Corneregel, Optixcare и аллогенная сыворотка. **Со слов владельца, регулярно Yellox не применяется:** 13.09.2026 он был дан однократно, пробно — именно этот эпизод отражён в анамнезе от 14.09.2026 («в воскресенье после Yellox лучше»). ⚠️ При этом назначение LoVet от 17.08.2026 предполагало Yellox 2×/день; расхождение между назначенной и фактически применяемой схемой ни в одном документе не зафиксировано, решение об отмене препарата нигде не оформлено.
...
## 14. Статус на последнюю задокументированную дату (14.09.2026)

- **Общее состояние:** по осмотру 14.09.2026 — **пациент стабилен**, без одышки, температура 38.5 °C. Со слов владельца неделя прошла волнообразно: 12.09 лучше, 13.09 хуже и неактивна, 14.09 после Yellox лучше. Частота дыхания дома 28–35/мин.
- **Онкология:** последняя доза доксорубицина (V) введена 07.09.2026; на визитах 11.09 и 14.09 химиопрепарат не вводился, 14.09 выполнен онкологический контроль. При сохранении 21-дневного интервала следующая доза приходилась бы примерно на 28.09.2026 — решение о ней в документах не зафиксировано. Palladia не применяется с 08.06.2026.
- **Плевральный выпот:** сохраняется. 11.09 — «столько же, сколько при последнем исследовании»; 14.09 — умеренное количество с обеих сторон. **От пункции 14.09 отказались ввиду стабильного состояния**; последняя фактическая пункция — в июле 2026.
- **Новая находка 14.09.2026:** на TFAST — разрастания в пределах стенки грудной клетки.
- **Гематология (IDEXX, 14.09.2026):** **нейтропении нет** (нейтрофилы 5.09 ×10⁹/л) на 7-й день после дозы доксорубицина; RBC, гематокрит и гемоглобин в пределах референса. Сохраняются сниженный MCH (11.1 пг), высокий RDW (31.4 %), лимфопения (0.83 ×10⁹/л) и тромбоцитоз (700 ×10⁹/л).
- **Биохимия (14.09.2026):** почечные и печёночные показатели в норме (креатинин 126 мкмоль/л, мочевина 6.85 ммоль/л, АЛТ 17, АЛП 39). За пределами референса — глюкоза 8.55 ↑ и калий 5.14 ↑. Фруктозамин назначен, результат не получен.
- **Почки:** ⚠️ на AFAST 14.09.2026 — изменённые почки **с обеих сторон** (неровный контур), при нормальной функции по биохимии. Ранее (24.06.2026) описывалась только левая почка.
- **ЖКТ:** аппетит стойко снижен, тошнота и дискомфорт. На AFAST 14.09 — поджелудочная железа пониженной эхогенности, незначительные признаки воспаления желудка. Назначены Peritol (стимулятор аппетита) и постоянное противорвотное Cerenia 60 мг 1/8 табл./день. Стул регулярный.
- **Глаза:** 10.09.2026 офтальмолог зафиксировал **ухудшение несмотря на интенсивное лечение**; установлены бандажные контактные линзы на оба глаза, добавлен противовирусный Acatavir, схема капель задана строгой последовательностью с интервалами. Офтальмологическая боль расценена как требующая постоянной анальгезии: с 14.09 бупренорфин каждые 12 часов «для глаз». **Со слов владельца, с 13.09.2026 капли даются с соблюдением интервалов, и к 16.09.2026 отмечается улучшение** — объективным осмотром пока не подтверждено, ближайший контроль до 24.09.2026.
- **Стероид:** снижался до 3/4 табл./день с 07.09.2026, но **возвращён к 1 целой таблетке (5 мг) 11.09.2026** и оставлен без изменений 14.09.
- **Фуросемид:** ⚠️ **возобновлён** — 13–14.09.2026 дан 10 мг, 1/4 таблетки, режим «по потребности». Прежнее утверждение о полной отмене с 27.07.2026 больше не действует.
- **Прочее:** симптом болезненности при пальпации грудного отдела позвоночника, впервые отмеченный 02.09.2026, в записях 11.09 и 14.09 не упоминается — прослежен ли он, неизвестно.
- Вес на 14.09.2026 — 4.78 кг по описанию осмотра (⚠️ 4.87 кг в поле «Waga» того же документа); за неделю с 07.09 фактически без динамики.
- Ближайший план по документам: **контроль через неделю** при стабильном самочувствии (то есть ~21.09.2026), при ухудшении — связаться с клиникой.
...
- **Уточнить реальную динамику плеврального выпота:** письменные УЗИ-измерения 02.09 и 07.09 различаются, но устные оценки 07.09, 11.09 и 14.09 сводятся к «без изменений»/«умеренное количество». Желательно при следующем контроле использовать сопоставимую методику оценки и чётко фиксировать динамику; отдельно стоит зафиксировать критерии, при которых выполняется пункция — 14.09.2026 от неё отказались ввиду стабильного состояния, при том что последняя фактическая пункция была в июле.
- **Дальнейшая судьба химиотерапии после дозы V (07.09.2026):** на визитах 11.09 и 14.09 препарат не вводился, решение о шестой дозе (ожидаемой ~28.09.2026) в документах не зафиксировано. Существенно, что на 14.09.2026 **нейтропении нет** — то есть гематологического препятствия к продолжению по этому бланку не видно.
...
- **Поджелудочная железа пониженной эхогенности и признаки воспаления желудка** (AFAST, 14.09.2026) на фоне стойкой тошноты и сниженного аппетита — панкреатит-специфичные тесты (fPLI/Spec fPL) не выполнялись.
- **Повторно повышенная глюкоза** (8.55 ммоль/л на 14.09.2026 — четвёртое повышенное значение подряд): фруктозамин на эту дату назначен и выполнен, но **результат не получен** — именно он позволил бы разграничить стрессовую гипергликемию и диабет.
- **Тромбоцитоз 700 ×10⁹/л** (14.09.2026, ранее 699 ×10⁹/л 13.06.2026) — ни разу не откомментирован врачом.
- **Возврат дозы кортикостероида к 5 мг/день 11.09.2026** — на следующий день после визита офтальмолога, зафиксировавшего ухудшение роговицы, при том что снижение стероида ранее рекомендовалось именно офтальмологом. Два решения между собой в документах не соотнесены, риск/польза не обсуждены.
...
- Дефекты эпителия роговицы указаны идентичными цифрами (70% / 80%) на двух последовательных визитах офтальмолога (25.08 и 03.09.2026) — нельзя достоверно судить, было ли реальное отсутствие динамики или шаблонное повторение текста в карте. На визите 10.09.2026 указано ~70% с обеих сторон, то есть по левому глазу цифра формально ниже, тогда как вывод того же документа — «ухудшение, бóльшие площади дефекта эпителия». Эти оценки нельзя использовать как измерения площади.
...
- **Результат фруктозамина от 14.09.2026** — услуга выполнена и оплачена, бланк не получен.
...
Документ может быть дополнен по мере поступления новых материалов и медицинских документов. Последнее дополнение — 16.09.2026, партия IMG_6100–6107 (документы 10.09–14.09.2026).
