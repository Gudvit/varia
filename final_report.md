...
| Чип | 968000011873589 |
| Дата рождения | Точная дата по документам не установлена. По четырём независимым записям возраста «лет и месяцев» в картах ALVET (см. ниже) — ориентировочно **август–сентябрь 2014 года**. |
...
Все четыре точки независимо указывают на **рождение в августе–сентябре 2014 года**. Клиники LoVet, Retina и ALPHAVET в разные периоды указывают возраст менее точно (только целыми годами — то «11», то «12» лет) — это, по всей видимости, связано с разными настройками округления в программах учёта этих клиник, а не с реальной неопределённостью возраста. Отдельно на бланке IDEXX от 24.06.2025 возраст указан грубо как «11 R», что для расчётной даты рождения давало бы фактически 10 лет 9–10 месяцев — то есть IDEXX, по-видимому, тоже просто округляет в большую сторону. На бланке биохимии LoVet от 02.09.2026 ошибочно указано «9 лет» — явная техническая ошибка, не использовать как источник возраста.
...
**Основной диагноз:** рак молочной железы высокой степени злокачественности (III степень по классификации Mills), гистологически подтверждён с августа 2025 года. Множественные локальные рецидивы (ноябрь 2025, декабрь 2025, март 2026), **метастазирование в лёгкие подтверждено 13.04.2026**. С апреля 2026 — рецидивирующий плевральный выпот и пролиферативные изменения стенки грудной клетки.

**Точный гистологический подтип опухоли (карцинома / саркома / карциносаркома) окончательно не определён** — патолог ALAB неоднократно указывал на необходимость иммуногистохимического окрашивания (панцитокератин, виментин) для уточнения; по документам не прослеживается, было ли оно выполнено.

**Текущая терапия (на 07.09.2026):** химиотерапия доксорубицином (введена V доза, интервалы строго по 21 дню); ранее — курс карбоплатина (одна задокументированная доза, 18.05.2026) до смены препарата; таргетная терапия торцеранибом (Palladia) — статус после 08.06.2026 не задокументирован ни в одном документе; преднизолон (доза снижена до 3/4 табл. к 07.09.2026); фуросемид при учащении дыхания; поддерживающая терапия ЖКТ и почек.
...
Также кошка получала Apoquel (антигистаминный/противозудный препарат) и была переведена на **почечную диету из-за повышенного креатинина по последнему на тот момент анализу**.
...
**Заключение: распространённая онкологическая болезнь с метастазами в лёгкие.** Принято решение начать терапию торцеранибом (**Palladia**) 10 мг, 1 табл. пн/ср/пт, в перчатках, не крошить/не делить, ввиду наличия метастатической болезни. Контроль через 2 недели.
...
Назначения: продолжить Palladia 10 мг пн/ср/пт; сохранить стероид 5 мг 1×/день вечером; добавлен **Libeo** (вероятно гепатопротектор) 1×/день 1/2 табл. утром; контроль через 2 недели. Вес 4.80 кг.
...
Назначения: Cyklonamina 250 мг 1/4 табл. 2×/день; преднизолон снижен до 5 мг 1 табл. 1×/день; Palladia — доза снижена до 10 мг пн/ср/пт, с 25.05.2026; фуросемид снижен до 1/4 табл. 1×/день; при поносе — Carobin Pet Forte; следующая химиотерапия — через 3 недели (ожидалось ~08.06.2026). Вес 4.80 кг.
...
Куплено: Famogast/Ranigast (фамотидин) 20 мг; **Varenzin 23.3 мг/мл, 27 мл** — 1 мл 1×/день в ротовую полость. Точное показание для Varenzin в документах не сформулировано врачом явно; учитывая находки со стороны почек и последующее выявление повышенного АД (26.08.2026), возможные причины — контроль артериального давления и/или протеинурия — но обе версии не подтверждены документами напрямую. Вес 4.94 кг.
...
**УЗИ: слева 2 см, справа 1.5 см жидкости — заметный рост объёма плеврального выпота за 5 дней от 02.09.2026.** Вес 4.77 кг.
...
**Вывод:** гистологически подтверждённый диагноз — рак молочной железы высокой степени злокачественности (III степень по Mills в первом образце), с прогрессирующим течением: от узкого, но чистого края резекции (08.2025) до края, вовлечённого опухолью (03.2026), и с появлением лимфоваскулярной инвазии к декабрю 2025 года. **Точный гистологический подтип (карцинома / саркома / карциносаркома) патолог не определил однозначно** — по заключению от 27.03.2026 для этого требуется дополнительное иммуногистохимическое окрашивание (панцитокератин, виментин); по документам не прослеживается, было ли оно выполнено. Общий прогноз врач ALVET прямо охарактеризовал как неблагоприятный (запись от 20.03.2026).
...
- с 11.05.2026: 15 мг, пн/ср/пт;
- с 25.05.2026 (назначено 18.05.2026): снижена до 10 мг, пн/ср/пт;
- подтверждена продолжающейся минимум до 08.06.2026 (куплена на этом приёме);
- **дальнейший статус после 08.06.2026 не задокументирован — не встречается ни в одном более позднем чеке или назначении.**
...
| 06.08.2025 | 35.7 ↓ | — | Впервые виден лёгкий микроцитоз |
| 31.10.2025 | 37.6 ↓ | 12.0 ↓ | Микроцитоз сохраняется |
| 20.12.2025 | 35.6 ↓ | 11.3 ↓ | Микроцитоз сохраняется |

Лёгкий микроцитоз (MCV ниже референса) — стабильный паттерн, документированный практически на всех анализах, начиная с августа 2025 года, то есть возникший вскоре после первой операции и сохраняющийся на протяжении всей дальнейшей истории болезни.
...
| Palladia (торцераниб) | 11.05.2026 – минимум 08.06.2026 | 15 мг → 10 мг с 25.05.2026; статус после 08.06.2026 не задокументирован |
| Prednicortone / преднизолон | с ~27.04.2026 | 5 мг/день → 7.5 мг (1.5 табл.) с 15.06 → 5 мг с 17.08 → 3/4 табл. с 07.09.2026 |
| Furosemid (фуросемид) | с ~11.05.2026 | 1/4 табл., доп. доза при учащении дыхания (схема закреплена 13.06.2026) |
...
| Varenzin 23.3 мг/мл | 19.08.2026 – 07.09.2026 | 1 мл/день; точное показание не сформулировано врачом; отменён 07.09.2026 |
...
| Comfortan (медетомидин) | 10.07.2026 | Седация для рентгена |
| Propomitor | 06.07.2026 (однократно) | Вероятно седативное/анестезиологическое средство |
| Libeo | с 29.04.2026 | 1/2 табл. утром; вероятно гепатопротектор |
| Neoplazmaxan | ~02.02.2026 | Состав и точное назначение по документам не определены |
| Apoquel (оклацитиниб) | на 13.04.2026 | Противозудный; причина назначения не уточнена |
| Carobin Pet Forte | 18.05.2026 | Пробиотическая паста, «на всякий случай» при поносе |
...
Для препаратов **Neoplazmaxan, Apoquel, Libeo, Varenzin, Sedatex, Propomitor** точный состав и/или точное клиническое показание по документам не определены — известны только названия, примерные даты начала приёма и, где указано, дозировка.
...
- **Онкология:** продолжается химиотерапия доксорубицином (доза V введена 07.09.2026, интервал 21 день); **растущий плевральный выпот** (слева 2 см, справа 1.5 см — рост за 5 дней от 02.09.2026); статус Palladia не задокументирован с 08.06.2026.
...
- **Точный гистологический подтип опухоли** (карцинома/саркома/карциносаркома) официально не подтверждён — по заключению ALAB от 27.03.2026 требовалось дополнительное иммуногистохимическое окрашивание, выполнение которого по документам не прослеживается.
...
- **Значительный рост объёма плеврального выпота** за 5 дней (02.09→07.09.2026).
...
- **Гистопатологический/цитологический диагноз опухоли грудной клетки** (образование у верхушки сердца, найдено 26.08.2026) — отсутствует.
...
- Причина и точный состав препаратов **Neoplazmaxan, Apoquel, Libeo** не определены по документам.
