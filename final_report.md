...
| **Терапия на 23.09.2026** | **Преднизолон:** 5 мг с 11.09, **снова снижен до 3/4 табл./день 21.09.2026**. **ЖКТ:** сукральфат 1 мл 2×/день; Helicid (омепразол) 20 мг 1/4 капс. 2×/день (⚠️ не указано, заменяет ли он Ranigast/фамотидин от 21.09); Cerenia 1×/день п/к и но-шпа п/к 1–2×/день (с 21.09); 23.09 в клинике нанесён **Mirataz** (трансдермальный миртазапин). **Обезболивание:** Bunondol (бупренорфин) 0.05 мл на слизистую, до эффекта, максимум 0.15 мл, **каждые 8 часов** (было — каждые 12 часов). **Глаза:** Acatavir, Tobrex, **Vigamox** (новый, 23.09), Vital Drop, Corneregel, Optixcare, сыворотка — строго по порядку с интервалами; бандажная линза осталась только на правом глазу. Фуросемид — по потребности (с 13–14.09) (разд. 9, 10). |

#### Активные проблемы на последнюю задокументированную дату

- **Роговица — угроза глазам:** 23.09.2026 — ухудшение несмотря на интенсивное лечение, **кератомаляция обоих глаз**, глубокая перилимбальная васкуляризация на 4 мм, преципитаты на эндотелии, гиперемия конъюнктивы, густые зеленоватые выделения; из левого глаза выпала бандажная линза. Поражение больше не ограничено эпителием. Зрительные реакции (menace, dazzle, PLR) пока сохранны. Рекомендована срочная операция (шанс ~60%); без неё возможна энуклеация. Улучшение, отмеченное владельцем к 16.09, осмотром не подтвердилось (разд. 10).
- **Отказ от еды и воды, гастрит, тошнота:** по анамнезу 23.09 — неделю около 1 чайной ложки корма в день, не пьёт. 21.09 на AFAST — чёткие признаки гастрита; тошнота не купируется ни Cerenia, ни ондансетроном, ни но-шпой. Вес −4% за 9 дней. Врач 23.09: «не отвечает на лечение воспаления желудка». Тест на панкреатит (fPL) запланирован 21.09, результата нет (разд. 12).
...
3. **Питание и гидратация:** неделя почти без еды и воды. Врач упоминает назальный зонд в условиях стационара.
...
⚠️ **Дальнейшие документы это улучшение не подтвердили.** 21.09.2026 со слов владельца записано, что кошка «по-прежнему мучается с глазом», а после сыворотки глаза становятся хуже и болезненнее; 23.09.2026 офтальмолог объективно зафиксировал ухудшение с кератомаляцией обоих глаз — после десяти дней применения капель с соблюдением интервалов (см. записи 21.09 и 23.09.2026 ниже).
...
#### 23.09.2026, 18:07 — Retina, lek. wet. Veronika Chybowska: 5-й визит офтальмолога

Анамнез: «Ухудшение». Возраст в документе — 12 лет 9 месяцев; кличка записана как «Waria».

Осмотр: **контактная линза в правом глазу на месте, из левого — выпала.** Описание обоих глаз идентично:

- увлажнение конъюнктивы и роговицы нарушено (низкий мениск, короткий NIBUT); **выделения густые, зеленоватые**;
- **конъюнктива гиперемирована** (10.09.2026 — «в норме»);
- роговица: **дефект эпителия ~70% поверхности, географической формы; глубокая перилимбальная васкуляризация на 4 мм; кератомаляция**;
...
Назначения — в указанном порядке: Acatavir 4×/день → 2 мин → Tobrex 4×/день → 2 мин → **Vigamox 4×/день (новый препарат)** → 2 мин → Vital Drop 3×/день → 5 мин → Corneregel 2×/день → 2 мин → Optixcare минимум 4–6×/день → 10 мин → сыворотка 4×/день (хранить в холодильнике). Процедуры: офтальмологический визит-продолжение.

**Vigamox** — глазные капли с моксифлоксацином (фторхинолоновый антибиотик); добавлен при появлении густых зеленоватых выделений, в дополнение к Tobrex.

⚠️ Площадь дефекта снова записана как ~70% с обеих сторон — та же цифра, что 10.09.2026, при словесном выводе «бóльшие площади». Качественно новыми являются другие находки: **кератомаляция** (размягчение, «таяние» стромы роговицы — то есть поражение уже не ограничено эпителием), **глубокая васкуляризация**, **преципитаты на эндотелии**, **гиперемия конъюнктивы** и **гнойные по виду выделения**. Именно они, а не проценты, меняют прогноз.

⚠️ Анамнез «ухудшение» и объективная картина 23.09 получены **после десяти дней применения капель с соблюдением интервалов** (с 13.09.2026) и девяти дней постоянного бупренорфина (с 14.09.2026). Улучшение, отмеченное владельцем к 16.09.2026, осмотром не подтверждено.
...
Анамнез (со слов владельца): визит срочный, на 15 минут. **Неделю съедает около 1 чайной ложки корма в день, не хочет есть, не хочет пить.** Глаза очень болят; сегодня был визит в Retina, «единственный шанс — операция с зашиванием век на 14 дней». Тошнота, позывы на рвоту; сегодня дан зофран — не действует; Cerenia тоже не подействовала, но-шпа тоже.
...
| Бандажные контактные линзы | установлены 10.09.2026 | Лечебные линзы на оба глаза («SZKŁO KONTAKTOWE 2») при обширных дефектах эпителия роговицы. На 23.09.2026 линза в правом глазу на месте, из левого — выпала |
| Vigamox (**моксифлоксацин**, глазные капли) | с 23.09.2026 | 4×/день, третьим в схеме после Acatavir и Tobrex; добавлен при густых зеленоватых выделениях |
...
**Итог на 23.09.2026:** двусторонний дефект эпителия роговицы на фоне синдрома сухого глаза, не заживающий с 17.08.2026 — более пяти недель, — **перешёл в кератомаляцию** (поражение стромы) с глубокой васкуляризацией и признаками вторичного воспаления/инфекции. Лечение было эскалировано последовательно — бандажные линзы, противовирусный препарат, постоянная опиоидная анальгезия, строгое соблюдение интервалов между каплями с 13.09, добавление Vigamox 23.09, — без эффекта. Офтальмолог рекомендует хирургическое лечение; зрительные реакции на 23.09 ещё сохранны.

⚠️ Количественные оценки площади дефекта по визитам — 70%/80% (25.08), 70%/80% (03.09), 70%/70% (10.09), 70%/70% (23.09) — не следует читать как измерения: на 10.09 и 23.09 цифры не растут, а вывод обоих документов — «ухудшение, бóльшие площади дефекта эпителия». На 23.09 ухудшение выражается прежде всего не в площади, а в глубине поражения (кератомаляция). Для суждения о динамике нужна сопоставимая методика оценки или фотодокументация.
...
- **Общее состояние:** по оценке лечащего врача LoVet 23.09.2026 — **плохое**, «виден огромный дискомфорт». Неделю почти не ест (около 1 чайной ложки в день) и не пьёт. Температура 38.5 °C, слизистые розовые, влажные. Врач рекомендует рассмотреть эвтаназию, если в ближайшие дни состояние не изменится.
- **Глаза:** 23.09.2026 — ухудшение с **кератомаляцией обоих глаз**, глубокой васкуляризацией, преципитатами на эндотелии и густыми зеленоватыми выделениями; линза в левом глазу выпала. Зрительные реакции сохранны. Офтальмолог рекомендует срочную операцию (кросслинкинг + ACell Vet + тарзорафия, шанс ~60%); без неё возможна энуклеация. Решение по операции на момент последнего документа не принято.
...
- **Неделя почти без еды и воды** (анамнез 23.09.2026) при потере ~4% массы за 9 дней: гидратация и питание вне стационара в документах не решены; стационарный вариант с назальным зондом упомянут только как часть подготовки к операции.
...
- **Сыворотка ухудшает состояние глаз** — со слов владельца (21.09.2026), после закапывания сыворотки усиливаются боль и ухудшение. В схеме офтальмолога от 23.09 сыворотка оставлена 4×/день без комментария; неизвестно, было ли это наблюдение передано в Retina.
...
- **13 файлов партии от 24.09.2026** («HEIF Image-470B-B964-61-10» … «-22») пришли пустыми — служебные файлы размером 135 байт без изображения, вероятно, результат неудачной передачи с телефона. Их содержимое неизвестно; требуется повторная отправка.
...
Документ может быть дополнен по мере поступления новых материалов и медицинских документов. Последнее дополнение — 24.09.2026, партия IMG_6188–6197 (документы 21.09–23.09.2026).
