...
## Клиническое резюме / текущий статус на 07.09.2026
...
| | |
| --- | --- |
| **Пациент** | Кошка, британская длинношёрстная, кастрирована, чёрная. Возраст ориентировочно 12 лет — ⚠️ дата рождения не установлена, расхождение между клиниками ~8–9 месяцев (разд. 2). Вес 4.77 кг на 07.09.2026; снижение с 5.2 кг в июле. |
...
| **Терапия на 07.09.2026** | Преднизолон 3/4 табл./день; доза снижена в августе–сентябре 2026, в т.ч. на фоне офтальмологической проблемы. **Фуросемид:** фактически отменён с 27.07.2026 и после этой даты не применяется. Varenzin отменён 07.09.2026; офтальмологическая схема капель и аллогенной сыворотки (разд. 9, 10). |

#### Активные проблемы на последнюю задокументированную дату

- **Плевральный выпот:** присутствует хронически/рецидивирует с апреля 2026 года. ⚠️ Динамика между 02.09 и 07.09 неоднозначна: числовые УЗИ-измерения увеличились (0.8→2.0 см слева; 0.53→1.5 см справа), однако лечащий онколог во время осмотра 07.09 устно охарактеризовала количество жидкости как примерно неизменное. Требуется стандартизированная повторная оценка.
...
4. **Уточнить реальную динамику плеврального выпота:** письменные УЗИ-измерения 02.09 и 07.09 различаются, но устная оценка онколога 07.09 — «примерно без изменений». Желательно при следующем контроле использовать сопоставимую методику оценки и чётко фиксировать динамику.
5. **Образование у верхушки сердца/в средостении:** определить, требует ли оно дополнительной визуализации/верификации и повлияет ли это на дальнейшую тактику.
...
**Текущая терапия (на 07.09.2026):** химиотерапия доксорубицином (введена V доза, интервалы строго по 21 дню); ранее — **одна документированная доза карбоплатина** (18.05.2026), на фоне которой продолжалась Palladia; запланированное следующее введение карбоплатина 08.06.2026 отменено/отложено из-за тяжёлой нейтропении, после чего, по словам владельца, были прекращены и карбоплатин, и Palladia; с 15.06.2026 начат доксорубицин. На 07.09.2026: преднизолон (доза снижена до 3/4 табл.); Varenzin отменён; фуросемид, по словам владельца, отменён с 27.07.2026 и после этой даты не применялся; поддерживающая терапия ЖКТ, почек и глаз.
...
- ⚠️ Динамика плеврального выпота между 02.09 и 07.09.2026 неоднозначна: письменные УЗИ-измерения различаются, но устная оценка онколога 07.09 со слов владельца — примерно без изменений.
...
- **Повышенный калий дважды подряд (06.07 и 10.07.2026)** во время периода, когда фуросемид ещё применялся по документам/со слов владельца (фуросемид обычно снижает калий), — не откомментирован врачом в документах.
...
| Фуросемид | 29.04.2026 – 27.07.2026 | Фуросемид применялся ранее при эпизодах учащённого дыхания/плеврального выпота. По словам владельца, полностью отменён с 27.07.2026 и после этой даты Варе не давался. В документах ранее фигурирует Libeo/Furosoral/фуросемид с изменяемой дозой в зависимости от дыхания и объёма плеврального выпота; в загруженных записях после 27.07.2026 явного нового назначения фуросемида не найдено |
...
- **Онкология:** продолжается химиотерапия доксорубицином (доза V введена 07.09.2026, интервал 21 день). Palladia применялась с 13.04.2026, в том числе параллельно с первой дозой карбоплатина 18.05.2026; после тяжёлой нейтропении 08.06.2026, по словам владельца, карбоплатин и Palladia прекращены, с 15.06.2026 начат доксорубицин. ⚠️ Динамика плеврального выпота между 02.09 и 07.09 неоднозначна: письменные УЗИ-измерения увеличились (0.8→2.0 см слева; 0.53→1.5 см справа), но устная оценка онколога 07.09 со слов владельца — примерно без изменений.
...
- **Фуросемид:** по словам владельца, полностью отменён с 27.07.2026 и после этой даты не применялся, включая 02.09 и 07.09.2026.
...
- Вес на 07.09.2026 — 4.77 кг; снижение с 5.2 кг в июле.
...
- **Уточнить реальную динамику плеврального выпота:** письменные УЗИ-измерения 02.09 и 07.09 различаются, но устная оценка онколога 07.09 со слов владельца — «примерно без изменений». Желательно при следующем контроле использовать сопоставимую методику оценки и чётко фиксировать динамику.
